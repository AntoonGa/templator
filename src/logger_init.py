"""File: logger_init.py | Author: agarcon | date: Sun Sep 22 2024

.. include:: readme.md
Description: A simple logger configuration.
In general this should be placed in the root of your package.
e.g. repo_root/src/package/__init__.py

This way the logger configuration is only loaded once when the package is
imported.
"""
...
class LogFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:  # noqa: A003, RUF100
        """Override the format method to add color to the log messages."""
