...
def download(request: DownloadRequest) -> Response:
    ...
    Args:
        request (DownloadRequest): Request parameters specifying the
...
def list_file() -> dict:
    ...
    Shows a list of files present in the Blob storage                 sds dsdsds dsd sdssdfdfdfdfdfdsdsfgfgfgfgfdsdsfdfdfdfjssssssdfdfdfdfdssss
